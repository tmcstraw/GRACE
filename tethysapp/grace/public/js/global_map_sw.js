...
var LIBRARY_OBJECT = (function() {
    ...
    add_wms = function(){
        ...
        var layer_name = 'sw_global:'+store_name;
    ...
    update_wms = function(date_str){
        ...
        var layer_name = 'sw_global:'+date_str;
        var sld_string = '<StyledLayerDescriptor version="1.0.0"><NamedLayer><Name>'+layer_name+'</Name><UserStyle><FeatureTypeStyle><Rule>\
        <RasterSymbolizer> \
        <ColorMap> \
        <ColorMapEntry color="#000000" quantity="'+cb_min+'" label="nodata" opacity="0.0" />'+
        ...
        $.ajax({
            ...
            success:function(result) {
                ...
                $("#plotter").highcharts({
                    ...
                    yAxis: {
                        title: {
                            text: "Total Surface Water Storage Anomaly (cm)"
                        }
                    ...
                    series: [{
                        ...
                        name: "Total Surface Water Storage Anomaly (cm)"
                    }]
                });
